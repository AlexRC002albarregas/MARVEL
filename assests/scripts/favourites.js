...
function print_characters() {
    ...
    if (Object.keys(data_holder).length !== 0) {
        listHolder.innerHTML = "";
        for (let d in data_holder) {
            if (data_holder.hasOwnProperty(d)) {
                if (d === 'length') {
                    continue;
                }
        ...
        listHolder.innerHTML = "<h1> No tienes ningún personaje favorito </h1>";
    }
}
